...
/*--------------------------------------------------------------------------------
 Include here Memory usage info for MacAppª
--------------------------------------------------------------------------------*/
...
nonpurgeable) {
	...
	apple,
	{
	"About EasyFitÉ", noIcon, noKey, noMark, plain, cAboutApp;
	"About Mario NegriÉ", noIcon, noKey, noMark, plain, cAboutIRFMN;
...
nonpurgeable) {
	...
	"OpenÉ",			noIcon, "O",	noMark, plain, cOpen;
	"-",				noIcon, noKey,	noMark, plain, nocommand;
	"Close",			noIcon, "W",	noMark, plain, cClose;
	"Save",				noIcon, "S",	noMark, plain, cSave;
	"Save AsÉ",			noIcon, noKey,	noMark, plain, cSaveAs;
	"Save a Copy InÉ",	noIcon, noKey,	noMark, plain, cSaveCopy;
	"Revert",			noIcon, noKey,	noMark, plain, cRevert;
	"-",				noIcon, noKey,	noMark, plain, nocommand;
	"Page SetupÉ",		noIcon, noKey,	noMark, plain, cPageSetup;
	"Print All PlotsÉ",			noIcon, noKey,	noMark, plain, cPrintAll;
	"Print WindowÉ",			noIcon, "P",	noMark, plain, cPrint;
	"-",				noIcon, noKey,	noMark, plain, nocommand;
...
nonpurgeable) {
	...
	"Fit",
	{
		...
		"Data & Model Plot OptionsÉ", noIcon, "D", noMark, plain, cDataAndFuncPlotOptions;
		"Standard Residuals Plot OptionsÉ", noIcon, "R", noMark, plain, cStdResPlotOptions;
		"Fit OptionsÉ", noIcon, noKey, noMark, plain, cFitOptions;
...
nonpurgeable) {
	...
	"Model",
	{
		"y = pç exp(-pè x)", noIcon, noKey, noMark, plain, cSingleExp;
		"y = pç exp(-pè x) + pé exp(-pê x)", noIcon, noKey, noMark, plain, cTwoExpPlus;
		"y = - pç exp(-pè x) + pé exp(-pê x)", noIcon, noKey, noMark, plain, cTwoExpMinus;
		"y = pç exp(-pè x) + pé exp(-pê x) + pì exp(-pë x)", noIcon, noKey, noMark, plain, cThreeExpPlus;
		"y = - pç exp(-pè x) + pé exp(-pê x) + pì exp(-pë x)", noIcon, noKey, noMark, plain, cThreeExpMinus;
		"User DefinedÉ", noIcon, "U", noMark, italic, cUserDefined;
	}
};
...
nonpurgeable) {
	...
	"Weights",
	{
		...
		"WLS wÛ = 1/yÛ (Observed Value)", noIcon, noKey, noMark, plain, cOneOverObsValue;
		"WLS wÛ = 1/yÛÚ (Observed Value)", noIcon, noKey, noMark, plain, cOneOverSqObsValue;
		"IRLS wÛ = 1/y(xÛ) (Estimated Value)", noIcon, noKey, noMark, plain, cOneOverEstimatedValue;
		"IRLS wÛ = 1/y(xÛ)Ú (Estimated Value)", noIcon, noKey, noMark, plain, cOneOverSqEstimatedValue;
		/* "ELS wÛ = a/y(xÛ)b", noIcon, noKey, noMark, plain, cELSWeights; */
