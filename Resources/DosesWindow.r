...
#define kDosesMaxRows 1
#define kDosesMaxCols kMaxSubjects

resource 'view' (kDosesWindowType,
#if qNames
"Doses",
#endif
purgeable) {{

	root, 'WIND', { 40, 10 }, { 84, 447 }, sizeVariable, sizeVariable, notShown, enabled, 
	Window{ "TWindow", zoomDocProc, goAwayBox, resizable, modeless, ignoreFirstClick, 
		...
		dontAdaptToScreen, dontStagger, dontForceOnScreen, dontCenter, noID, "Doses Ò<<<>>>Ó" };
	...
	'prnt', 'SCL1', { 2*kCellHeight, 32 }, { kCellHeight, 400 }, sizeRelSuperView, sizeRelSuperView, shown, enabled, 
	Scroller {"TTableScroller", noVertScrollBar, HorzScrollBar, kCellHeight, kCellWidth, 0, 0, VertConstrain, 
		 HorzConstrain, {-16, -31, 0, 0 }}, 

	'SCL1', 'CELL', { 0, 0 }, { 0, 0 }, sizeVariable, sizeVariable, shown, enabled, 
	TextGridView {"TCellsView", kDosesMaxRows, kDosesMaxCols, kCellHeight, kCellWidth, kRowInset, kColumnInset, AdornRows, AdornCols, 
	...
	TextGridView {"TColumnsView", 1, kDosesMaxCols, kColumnTitleHeight, kCellWidth, 0, kColumnInset, dontAdornRows, AdornCols, 
		multipleSelection, bold, kFontSize, { 0x0, 0x0, 0x0 }, "a" }, 

	'prnt', 'SCL3', { 2*kCellHeight, 0 }, { kCellHeight, 32 }, sizeRelSuperView, sizeVariable, shown, enabled, 
	...
	TextGridView {"TRowsView", kDosesMaxRows, 1, kCellHeight, kRowTitleWidth, kRowInset, 0, AdornRows, dontAdornCols, 
		multipleSelection, bold, kFontSize, { 0x0, 0x0, 0x0 }, "a" }, 
