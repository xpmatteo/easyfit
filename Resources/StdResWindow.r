...
#define kStdResColsPerSubj 5
#define kStdResMaxRows kMaxObservations
#define kStdResMaxCols kMaxSubjects * kStdResColsPerSubj

resource 'view' (kStdResWindowType,
#if qNames
"StdRes",
#endif
purgeable) {{
	...
	Window{ "TWindow", zoomDocProc, goAwayBox, resizable, modeless, ignoreFirstClick, 
		...
		dontAdaptToScreen, dontStagger, dontForceOnScreen, dontCenter, noID, "Standard Residuals Ò<<<>>>Ó" };
	...
	TextGridView {"TCellsView", kStdResMaxRows, kStdResMaxCols, kCellHeight, kCellWidth, kRowInset, kColumnInset, AdornRows, AdornCols, 
	...
	TextGridView {"TColumnsView", 1, kStdResMaxCols, kColumnTitleHeight, kCellWidth, 0, kColumnInset, dontAdornRows, AdornCols, 
	...
	TextGridView {"TRowsView", kStdResMaxRows, 1, kCellHeight, kRowTitleWidth, kRowInset, 0, AdornRows, dontAdornCols, 
		multipleSelection, bold, kFontSize, { 0x0, 0x0, 0x0 }, "a" }, 
