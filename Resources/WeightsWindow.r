...
#define kWeightsMaxRows kMaxObservations
#define kWeightsMaxCols kMaxSubjects

resource 'view' (kWeightsWindowType,
#if qNames
"Weights",
#endif
purgeable) {{
	...
	Window{ "TWindow", zoomDocProc, goAwayBox, resizable, modeless, ignoreFirstClick, 
		...
		dontAdaptToScreen, dontStagger, dontForceOnScreen, dontCenter, noID, "Weights Ò<<<>>>Ó" };
	...
	TextGridView {"TCellsView", kWeightsMaxRows, kWeightsMaxCols, kCellHeight, kCellWidth, kRowInset, kColumnInset, AdornRows, AdornCols, 
	...
	TextGridView {"TColumnsView", 1, kWeightsMaxCols, kColumnTitleHeight, kCellWidth, 0, kColumnInset, dontAdornRows, AdornCols, 
	...
	TextGridView {"TRowsView", kWeightsMaxRows, 1, kCellHeight, kRowTitleWidth, kRowInset, 0, AdornRows, dontAdornCols, 
		multipleSelection, bold, kFontSize, { 0x0, 0x0, 0x0 }, "a" }, 
